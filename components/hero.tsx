...
const FloatingPaper = dynamic(async () => (await import("@/components/floating-paper")).default, { ssr: false })
const RoboAnimation = dynamic(async () => (await import("@/components/robo-animation")).default,  { ssr: false })
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
              Detect deepfakes in images with
